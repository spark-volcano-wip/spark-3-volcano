...
import org.apache.spark.scheduler.cluster.k8s.ExecutorPodsLifecycleManager.UNKNOWN_EXIT_CODE
...
private[spark] class VolcanoExecutorPodsLifecycleManager(
    val conf: SparkConf,
